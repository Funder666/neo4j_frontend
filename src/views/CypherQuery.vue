...
`;
    ...
    // 创建Blob对象
    const blob = new Blob([apiDocContent], {
    ...
    ElMessage.success('API使用文档下载成功！');

  } catch (error) {
    console.error('下载API文档失败:', error);
    ElMessage.error('下载API文档失败: ' + error.message);
  } finally {
